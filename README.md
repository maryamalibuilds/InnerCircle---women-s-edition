# InnerCircle — Private Wellness App for Women

A multi-page private wellness web application focused on journaling, mood tracking, and personal reflection with a clean, user-centered design.
